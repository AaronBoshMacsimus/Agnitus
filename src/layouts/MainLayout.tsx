...
export default function MainLayout() {
  ...
  return (
    <div className="bg-transparent relative min-h-dvh w-full transition-colors duration-1000">
      ...
      <div
        ref={mobileHeaderRef}
        className="border-border-custom/30 bg-background/30 backdrop-blur-md fixed top-6 left-1/2 z-50 flex h-14 w-[90%] -translate-x-1/2 items-center justify-between overflow-hidden rounded-[5px] border px-4 md:hidden"
        style={{
          opacity: revealed ? 1 : 0,
      ...
      <div
        ...
        style={{
          opacity: revealed ? 1 : 0,
          transition: "opacity 1s",
          pointerEvents: revealed ? "auto" : "none", // Although class has pointer-events-none, the children (menu button) have pointer-events-auto
        }}
      >
